...
/**
 * Class Story_MagicController
 */
class Story_MagicController extends Zend_Controller_Action
{
    ...
    public function showAction() {
        ...
        $html = $this->view->render('magic/show.phtml');
    ...
    public function removalAction() {
        ...
        $html = $this->view->render('magic/removal.phtml');
        echo json_encode(['html' => $html]);
        exit;
    }
